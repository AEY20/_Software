...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {cikis_and}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {cikis_or}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {cikis_xor}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {cikis_nand}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {cikis_nor}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {cikis_xnor}];  # "LD5"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {giris_1}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {giris_2}];  # "SW1"
