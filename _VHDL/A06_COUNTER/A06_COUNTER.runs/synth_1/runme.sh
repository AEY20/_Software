...
HD_PWD='C:/Users/AEY/Google Drive/01_Github/_Software/_VHDL/A06_COUNTER/A06_COUNTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sayac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sayac.tcl
