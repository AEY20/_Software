...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {in_clk}];  # "GCLK"
...
#User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {out_clk_1hz}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {out_clk_1_2hz}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {out_clk_1_4hz}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {out_clk_1_8hz}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {out_clk_1_16hz}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {out_clk_1_nhz}];  # "LD5"
...
set_property PACKAGE_PIN T18 [get_ports {in_rst}];  # "BTNU"
