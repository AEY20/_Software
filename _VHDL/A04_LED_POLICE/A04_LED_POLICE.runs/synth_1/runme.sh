...
HD_PWD='C:/Users/AEY/Google Drive/01_Github/_Software/_VHDL/A04_LED_POLICE/A04_LED_POLICE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_yakma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_yakma.tcl
