...
HD_PWD='C:/Users/AEY/Google Drive/01_Github/_Software/_VHDL/A04_LED_POLICE/A04_LED_POLICE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_yakma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_yakma.tcl -notrace
