...
HD_PWD='C:/Users/AEY/Google Drive/01_Github/_Software/_VHDL/A05_LEDYAK/A05_LEDYAK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledyak.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledyak.tcl -notrace
